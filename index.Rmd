...
This `.Rmd` file replicates all analyses and saves tables and figures as outputs from [Incentives can spur Covid-19 vaccination uptake](https://osf.io/ax6pw/).
Data used can be downloaded [here](https://wzb-ipi.github.io/covid_hesitancy_2021/input/wave_1/D-P21-13185%20HU%20Berlin%20Impfskeptiker_Finaler_Datensatz.sav).
...
Code chunk uses `pacman` to install and load all packages.
...
Code chunk provides paths for pulling data and saving figures and tables.

```{r}

datapath <- "input/wave_1/D-P21-13185 HU Berlin Impfskeptiker_Finaler_Datensatz.sav"
